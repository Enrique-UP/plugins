...
<html>
  ...
  <body>
    <main>
      ...
      <section class="section imageContent nature philanthropy">
        <div class="container-fluid">
            <div class="row images"> 
                <div class="col-md-8"><img src="./images/interest.jpg" alt=""></div>
                <div class="col-md-4"><img src="./images/interest.jpg" alt=""></div>
            </div>
        </div>
        <div class="container">
            <div class="row images"> 
