...
<html>
  ...
  <body>
    <main class="home">
      ...
      <section class="sectionT imageContent">
        <div class="container">
          <div class="row images"> 
            <div class="col-sm-6 col-md-4"><img src="./images/interest.jpg" alt=""></div>
            <div class="col-sm-6 col-md-4"><img src="./images/interest.jpg" alt=""></div>
            <div class="col-sm-6 col-md-4"><img src="./images/interest.jpg" alt=""></div>
            <div class="col-sm-6 col-md-4"><img src="./images/interest.jpg" alt=""></div>
            <div class="col-sm-6 col-md-4"><img src="./images/interest.jpg" alt=""></div>
      ...
      <section class="section imageContent sing left">
        <div class="container">
          <div class="row"> 
            <div class="col-md-6">
              <figure class="image"><img src="./images/interest.jpg" alt=""></figure>
            </div>
            <div class="col-md-6">
              <div class="content">
                <h1>Lorem ipsum dolor sit amet consectetur atque incidunt facere ex amet doloremque</h1>
